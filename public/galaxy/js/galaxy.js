var galacticTexture0 = THREE.ImageUtils.loadTexture( "/ganmenx128-reverse.png" );
var galacticTexture1 = THREE.ImageUtils.loadTexture( "/ganmenx128-reverse	.png" );
...
function generateGalaxy(){
	...
	var galacticTopMaterial = new THREE.MeshBasicMaterial({
		map: THREE.ImageUtils.loadTexture('/ganmenx128-reverse.png'),
		blending: THREE.AdditiveBlending,
		depthTest: false,
		depthWrite: false,
